              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Cash flow projections with 12-month forecasting will be available here.
                ...
                <TabsContent value="balance">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Balance sheet with assets, liabilities, and net worth tracking will be available here.
                        Database schema created successfully.
                      </p>
                    </CardContent>
                  </Card>
